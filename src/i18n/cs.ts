...
export const cs: Dictionary = {
  ...
  ui: {
    ...
    checkout: {
      ...
      email: 'E-mail',
      phone: 'Telefon',
      shippingAddr: 'Doručovací adresa',
      street: 'Ulice a číslo popisné',
      city: 'Město',
      zip: 'PSČ',
      note: 'Poznámka k objednávce (nepovinné)',
      payment: 'Způsob platby',
      cod: 'Dobírka / bankovní převod',
      codNote: 'Podklady k platbě vám zašleme e-mailem.',
      card: 'Platba kartou online',
      cardSoon: 'Již brzy',
      cardNote: 'Bezpečná platba přes Stripe — karta, Apple Pay, Google Pay.',
      payNow: 'Zaplatit kartou',
      canceled: 'Platba byla zrušena. Objednávka nebyla dokončena — zkuste to prosím znovu.',
      successPaid: 'Platba proběhla úspěšně. Potvrzení vám zašleme na e-mail.',
      summary: 'Souhrn objednávky',
      placeOrder: 'Odeslat objednávku',
      placing: 'Odesílám…',
      successTitle: 'Děkujeme za objednávku! 🎉',
